    ...
    INSPIRO.loader = function () {
        ...
        if (!$body.hasClass('no-page-loader')) {
            ...
            var pageInAnimation = $body.attr('data-animation-in') || "fadeIn",
                ...
                pageLoaderStylePath = $body.attr('data-animation-icon-path') || "/bitrix/templates/getbacker/assets/images/svg-loaders/",
                pageLoaderStyle = $body.attr('data-animation-icon') || "grid.svg",
