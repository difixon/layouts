...
// XDM object
  w.fastXDM = {
    _id: 0,
    helperUrl: ((location.protocol === 'https:') ? 'https:' : 'http:') + '//web.archive.org/web/20151202010729/https://vk.com/js/api/xdmHelper.js',
 ...
 * https://web.archive.org/web/20151202010729/http://vk.com/
 */
...
if (!VK.xdConnectionCallbacks) {
  ...
  VK.extend(VK, {
    ...
    _userStatus: 'unknown',
    _domain: {
      main: 'https://web.archive.org/web/20151202010729/https://oauth.vk.com/',
      api: 'https://web.archive.org/web/20151202010729/https://api.vk.com/'
    },
    _path: {
      login: 'authorize',
    ...
    VK.Api = {
        ...
        xhr.onload = function() {
          ...
          if (xhr.status === 200) {
            ...
            try {
              ...
              //web.archive.org/web/20151202010729/https://nop/
            }
          }
        };
      ...
      checkMethod: function(method, params, cb, queryTry) {
        ...
        if (m == 'wall.post' || m == 'activity.set') {
          ...
          var query =  VK._protocol + '//web.archive.org/web/20151202010729/https://vk.com/al_apps.php?act=wall_post_box&widget=1&method='+m+'&aid=' + parseInt(VK._apiId, 10) + '&text=' + encodeURIComponent(text);
          if (m == 'wall.post') {
  ...
  if (!VK.Auth) {
    VK.Auth = {
      ...
      revokeGrants: function(cb) {
        ...
        if (VK._session && VK._session.sid) {
          var url = 'https://web.archive.org/web/20151202010729/https://login.vk.com/?act=openapi&oauth=1&aid=' + parseInt(VK._apiId, 10) + '&location=' + encodeURIComponent(window.location.hostname) + '&do_logout=1&token=' + VK._session.sid;
      ...
      getLoginStatus: function(cb, force) {
        ...
        var url = 'https://web.archive.org/web/20151202010729/https://login.vk.com/?act=openapi&oauth=1&aid=' + parseInt(VK._apiId, 10) + '&location=' + encodeURIComponent(window.location.hostname);
        if (VK.Api.supportCORS()) {
          var loginCallback = function(response) {
            ...
            if (typeof JSON.parse !== 'function') {
              //web.archive.org/web/20151202010729/https://IE6/ and IE7
...
if (!VK.Widgets) {
  ...
  VK.Widgets.loading = function(obj, enabled) {
    obj.style.background = enabled ? 'url("' + VK._protocol + '//web.archive.org/web/20151202010729/https://vk.com/images/upload.gif") center center no-repeat transparent' : 'none';
  };
  ...
  VK.Widgets.Comments = function(objId, options, page) {
    ...
    return VK.Widgets._constructor('widget_comments.php', objId, options, params, {
      showBox: function(url, props) {
        var box = VK.Util.Box((options.base_domain || VK._protocol + '//web.archive.org/web/20151202010729/https://vk.com/') + '/' + url, [], {
          proxy: function() {
    ...
    return VK.Widgets._constructor('widget_like.php', objId, options, params, {
      initTooltip: function(counter) {
        tooltipRpc = new fastXDM.Server({
          ...
          showBox: function(url, props) {
            var box = VK.Util.Box((options.base_domain || VK._protocol + '//web.archive.org/web/20151202010729/https://vk.com/') + url, [props.width, props.height], {
              proxy: function() {
  ...
  VK.Widgets.Ads = function(objId, options, paramsExtra) {
    ...
    function adsAttachScript(adsScriptVersion) {
      if (!('vk__adsLight' in window)) {
        ...
        var base_domain = (options.base_domain || VK._protocol + '//web.archive.org/web/20151202010729/https://vk.com/');
  ...
  VK.Widgets._constructor = function(widgetUrl, objId, options, params, funcs, defaults, onDone, widgetId, iter) {
    ...
    base_domain = options.base_domain || VK._protocol + '//web.archive.org/web/20151202010729/https://vk.com/';
    ...
    funcs.updateVersion = function(ver) {
      if (ver > 1) {
        VK.Api.attachScript('//web.archive.org/web/20151202010729/https://vk.com/js/api/openapi_update.js'+parseInt(ver));
      }
    }
...
/*
     FILE ARCHIVED ON 01:07:29 Dec 02, 2015 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 12:05:11 Aug 23, 2017.
